...
interface StoreBackend {
     ...
     */
    fun verify(transaction: Transaction, transactionSignature: ByteArray): Boolean
     ...
     * private key in the client side.
     * @param password    the password for the user associated with the `transaction`.
     * @return true if the password is verified.
     */
    fun verify(transaction: Transaction, password: String): Boolean
     ...
     */
    fun enroll(userId: String, password: String, publicKey: PublicKey): Boolean
}
